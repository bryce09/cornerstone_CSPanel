...
public class CSPanel extends Activity {
	...
	Log.w("cornerstone", "on create3");
         ...
         */
	Log.w("cornerstone", "on initialize the UI controls at startup of the ");
        initializeControls();
        ...
        */
	Log.w("cornerstone", "Update the UI controls in UI thread when WMS notifies the cornerstone app");
		...
		public void handleMessage(Message msg) {
            ...
            */
	Log.w("cornerstone", "ets the appropriate cs title for the app running in cs panel");
        ...
        */
	Log.w("cornerstone", "Registers the ICornerstoneManager interface with AMS");
        try{
